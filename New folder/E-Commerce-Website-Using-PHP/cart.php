  ...
  ?>
						<table class="tblone">
							...
							<tr>
								...
								<td><img src="../dashboard -blue/<?php echo $result['image']; ?>" alt=""/></td>
								...
								<td><a onclick="return confirm('Are you sure to delete?');" href="?delpro=<?php echo $result['cartId']; ?>">Remove</a></td>
							</tr>
							<?php
