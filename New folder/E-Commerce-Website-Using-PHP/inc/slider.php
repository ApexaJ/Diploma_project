			...
			<div class="section group">
				...
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
						 <a href="details.php?proId=<?php echo $result['productId']; ?>"> <img src="../dashboard -blue/<?php echo $result['image']; ?>" alt="" /></a>
					</div>
		   ...
		   <!-- FlexSlider -->
			...
			<section class="slider">
				  <div class="flexslider">
					<ul class="slides">
						<li><img src="images/1.jpg" alt="" height="320px" width="auto" /></li>
						<li><img src="images/2.jpg" alt="" height="320px" width="auto" ></li>
						<li><img src="images/3.jpg" alt="" height="320px" width="auto"/></li>
						<li><img src="images/4.jpg" alt="" height="320px" width="auto"/></li>
				    </ul>
				  </div>
	      </section>
<!-- FlexSlider -->
